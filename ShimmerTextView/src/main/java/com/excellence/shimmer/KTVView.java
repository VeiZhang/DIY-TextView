...
/***
 * Created by ZhangWei on 2016/6/22.
 */
public class KTVView extends View
{
	...
	public KTVView(Context ctx)
	{
		this(ctx, null);
	}

	public KTVView(Context context, AttributeSet attrs)
	{
		this(context, attrs, 0);
	}

	public KTVView(Context context, AttributeSet attrs, int defStyleAttr)
	{
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		{
			// 由图片决定的宽
			int desireByImg = getPaddingLeft() + getPaddingRight() + 380;
		...
		{
			int desire = getPaddingTop() + getPaddingBottom() + 80;
	...
	protected void onDraw(Canvas canvas)
	{
		...
		srcCanvas.drawText(mText, 0, getPaddingTop() + 30, mPaint);
